...
/* ─── palette ─────────────────────────────────────────────
   Cinematic warm tungsten — matching the amber laundromat glow.

   Background  : warm near-black       #1A1410
   Text        : warm cream             #F0E6D8
   Accent      : amber / golden glow    #D4943C
   ───────────────────────────────────────────────────────── */
...
export default function IntimeAuCommun() {
  return (
    <main className="min-h-screen flex flex-col" style={{ backgroundColor: BG, color: TXT }}>
      ...
      {/* ─ Hero — image pleine largeur en fond */}
      ...
      <section className="w-full px-6 md:px-12 py-20 md:py-28">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-12 md:gap-20 items-start">
          ...
          >
            ...
            <div className="w-10 h-[2px] rounded-full" style={{ backgroundColor: `${AMBER}60` }} />
          </motion.div>
      ...
      {/* ─ Grille de photos — masonry-like layout */}
      <section className="w-full px-6 md:px-12 py-4">
        <div className="max-w-5xl mx-auto">
          {/* Row 1: deux portraits cote a cote */}
          ...
          {/* Row 2: une grande image pleine largeur */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
      ...
      <section className="w-full px-6 md:px-12 py-16 md:py-24">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            className="mb-8"
          >
            <span className="text-xs tracking-[0.3em] uppercase" style={{ color: `${TXT}35` }}>Le fanzine</span>
          </motion.div>
          <motion.div
