    ...
    >
      ...
      <section className="w-full px-6 md:px-12 py-20 md:py-32">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div>
              <span className="text-xs tracking-[0.3em] uppercase opacity-40 block mb-4">
                À propos du projet
              </span>
              <div
            ...
            <div className="flex flex-col gap-8">
              <p className="text-xl md:text-3xl font-light leading-relaxed opacity-80">
                Ce projet interroge les postures du quotidien dans l&apos;espace
                public. À travers des maquettes et des silhouettes, il capture
                les gestes inconscients que nous adoptons dans les lieux de
                passage — attente, mouvement, immobilité. Une observation
                sensible du corps dans son environnement.
              </p>
              <p className="text-base md:text-xl font-light leading-relaxed opacity-70">
                À travers une scénographie aménagée dans un espace
                d&apos;attente, il capture les gestes inconscients que nous
                adoptons dans les lieux de passage. Une observation sensible du
                corps, qui permet à la fois d&apos;allier contemplation et
                utile.
              </p>
            </div>
          </motion.div>
      ...
      <section className="w-full py-20 md:py-32 overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 md:px-12 mb-10">
          ...
          >
            <div>
              <span className="text-xs tracking-[0.3em] uppercase opacity-40 block mb-3">
                Photographies
              </span>
            ...
            <div className="flex gap-2">
              <button
                ...
                onMouseLeave={(e) => {
                  ...
                  e.currentTarget.style.borderColor = `${TXT}20`;
                }}
              >
        ...
        >
          ...
          >
            {carouselImages.map((img, index) => (
              <div
                key={index}
                className="shrink-0 w-[80vw] md:w-[40vw] lg:w-[30vw]"
              >
                <LightboxImage
                  src={img.src}
                  alt={img.alt}
