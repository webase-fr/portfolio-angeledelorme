  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-[60] flex justify-between items-center px-6 md:px-10 py-5 transition-all duration-500 ${
        scrolled
          ? "bg-[#E6DCD1]/90 backdrop-blur-md"
          : ""
      }`}
    >
      <Link href="/" className="flex items-center gap-3">
        <span className={`text-lg md:text-xl font-light tracking-[0.15em] uppercase transition-colors duration-500 ${
      ...
      <nav className={`hidden md:flex items-center gap-8 text-xs font-medium uppercase tracking-[0.2em] transition-colors duration-500 ${
